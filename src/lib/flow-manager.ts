...
import { RequestNode } from '../flowy/components/nodes/request';
import { SelectNode } from '../flowy/components/nodes/select';
import { TriggerNode } from '../flowy/components/nodes/trigger';
import { AppNode, HandleId } from '../flowy/types';
import { runPromisesInBatchSequentially } from '../flowy/utils/promise';
import { Subscribable } from './subscribable';
import { Edge } from '@xyflow/react';

type Listener = (data: Map<string, StepResult>) => void;

type Status = 'idle' | 'running' | 'paused' | 'finished';

export type StepResult<R = unknown, E = unknown> = {
  status: Status;
  data?: R;
  error?: E;
};
...
export class FlowManager extends Subscribable<Listener> {
...
class FlowyError extends Error {
